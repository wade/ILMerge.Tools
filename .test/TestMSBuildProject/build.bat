...
::-----------------------------------------------------------------------------
::
SET MSBUILDPROJ=%ROOTDIR%.build\build.proj
SET MSBUILDTESTPROJ=%ROOTDIR%.test\TestMSBuildProject\build.proj
::
::-----------------------------------------------------------------------------
::
SET MSBUILDCOMMAND=%MSBUILDEXE% %MSBUILDPROJ% /p:Configuration=%BUILDCONFIG%;RootDir=%ROOTDIR%;ShouldRunTests=%SHOULDRUNTESTS%
SET MSBUILDTESTCOMMAND=%MSBUILDEXE% %MSBUILDTESTPROJ% /p:Configuration=%BUILDCONFIG%;RootDir=%ROOTDIR%;ShouldRunTests=%SHOULDRUNTESTS%
::
::-----------------------------------------------------------------------------
::
ECHO.
...
ECHO MSBUILDTESTPROJ...: %MSBUILDTESTPROJ%
ECHO.
ECHO %MSBUILDCOMMAND%
ECHO.
::
